...
class ImageLruCache {
  ...
  static Uint8List? getData(AssetEntity entity, [int size = 64, ThumbFormat format = ThumbFormat.jpeg]) {
    return _map.get(_ImageCacheEntity(entity, size, format));
  }

  static void setData(AssetEntity entity, int size, ThumbFormat format, Uint8List list) {
...
class _ImageCacheEntity {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is _ImageCacheEntity && runtimeType == other.runtimeType && entity == other.entity && size == other.size && format == other.format;
