...
extension MyColorScheme on ColorScheme {
  ...
  Color get textThemeRedColor => getColorTheme(ColorName.redColor, ColorName.redColor);
  ...
  Color get themeGrayColor => getColorTheme(ColorName.textGreyColor, ColorName.textGreyColor);

  Color get themeGray2Color => getColorTheme(greyBorderColor, greyBorderColor);
