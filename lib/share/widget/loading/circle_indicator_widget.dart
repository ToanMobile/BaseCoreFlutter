...
class CircleIndicatorWidget extends StatefulWidget {
  ...
  const CircleIndicatorWidget(this.size, this.totalStep, this.currentStep, {this.selectedColor, this.unselectedColor, this.itemMargin});
    ...
    for (int i = 0; i < widget.totalStep; i++) {
      ...
      items.add(Container(
        ...
        decoration: BoxDecoration(
            ...
            color: i == widget.currentStep ? widget.selectedColor ?? getColor().themePrimaryColor : widget.unselectedColor ?? getColor().themeGrayColor),
      ));
    }
    return Row(
