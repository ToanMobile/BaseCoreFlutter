    ...
    return CupertinoPicker(
      ...
      children: items
          .map((item) => Center(
                child: Text(
                  item,
                  style: text18.medium.textBlackColor,
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: widget.initItemIndex == index
              ? getColor().themePrimaryColor
              : getColor().themeWhiteColor,
          border: Border(
              bottom: BorderSide(
                  color: getColor().onPrimary, width: 0.75)),
        ),
        child: Text(
          item,
          style: widget.initItemIndex == index
              ? text14.textPrimaryColor
              : text14.textGreyColor,
        ),
      ),
    );
  }
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
              bottom: BorderSide(
                  color: getColor().themePrimaryColor, width: 0.75)),
        ),
        child: Text(
          item,
